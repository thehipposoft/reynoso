        ...
        <div className='max-w-[80vw] md:max-w-[1250px] mx-auto flex flex-col'>
            <div className='flex flex-col py-12 border-b border-primary-green'>
                <div className='flex flex-col md:flex-row justify-center  items-center gap-8 md:gap-16'>
                    <Image src={'/assets/images/logo/logo-white.png'} alt='' width={180} height={140} />
                    <div className='flex justify-between flex-wrap gap-12'>
                        <ul className='flex flex-col gap-2'>
                            <h4 className='text-white font-bold text-lg'>Desarrollos</h4>
                            <li className='text-white'>Citadino</li>
                            <li className='text-white'>Ladera Norte</li>
                            <li className='text-white'>Campo Nuevo</li>
                            <li className='text-white'>Los Arreboles</li>
                            <li className='text-white'>Campo nuevo 3</li>
                            <li className='text-white'>Senderos</li>
                            <li className='text-white'>Maruyama</li>
                        </ul>
                        <h4 className='text-white text-lg font-bold'>Alquileres</h4>
                        <h4 className='text-white text-lg font-bold'>Nosotros</h4>
                        <h4 className='text-white text-lg font-bold'>Contacto</h4>
                        <h4 className='text-white text-lg font-bold'>Explore Me</h4>
                        <div className='flex flex-col justify-between'>
                            <h4 className='text-white text-lg font-bold'>Venta</h4>
                            <div className='flex flex-col pt-4'>
                                <h4 className='text-white text-lg font-bold'>Seguinos!</h4>
            ...
            <div className='flex pt-8 pb-4 justify-center items-center'>
                <Link className='text-center text-white' href={'/www.thehipposoft.com'} rel='noreferrer' target='_blank'>Created by <strong>HippoSoft</strong> | All Right Reserved</Link>
            </div>
        </div>
    </div>
  )

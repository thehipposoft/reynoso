                        ...
                        <div className='flex flex-col justify-between'>
                            ...
                            <div className='flex flex-col pt-4'>
                                ...
                                <div className='flex lg:gap-2 gap-4 pt-4'>
                                    <AnimatedLink href={'https://www.instagram.com/reynosobienesraicessalta'} rel='noreferrer' target='_blank' className='w-12 h-12 rounded-full flex items-center justify-center group hover:bg-white/10 hover:scale-110 bg-white duration-500'>
                                    ...
                                    <AnimatedLink href={'https://www.facebook.com/reynosobienesraices/'} rel='noreferrer' target='_blank' className='w-12 h-12 rounded-full flex items-center justify-center group hover:bg-white/10 hover:scale-110 bg-white duration-500'>
                                    ...
                                    <AnimatedLink href={'https://www.linkedin.com/company/reynoso-bienes-raices/'} rel='noreferrer' target='_blank' className='w-12 h-12 rounded-full flex items-center justify-center group hover:bg-white/10 hover:scale-110 bg-white duration-500'>
                                    ...
                                    <AnimatedLink href={'https://www.youtube.com/@reynosobienesraices4815'} rel='noreferrer' target='_blank' className='w-12 h-12 rounded-full flex items-center justify-center group hover:bg-white/10 hover:scale-110 bg-white duration-500'>

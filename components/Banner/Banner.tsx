...
const Banner = ({
  ...
  return (
    <div className='flex h-screen bg-black/60'>
        ...
        <div onMouseEnter={handleSecondMouseEnter} onMouseLeave={handleSecondMouseLeave} className={`${isFirstHovered ? '-z-10 opacity-0' : 'z-10 '} ${isSecondHovered ? 'bg-[#33847d80] ' : 'bg-title-color/70'} hover:backdrop-blur-none duration-700 w-1/2 flex flex-col justify-center items-center backdrop-blur-xs relative z-10`}>
            <div className='w-full h-full flex flex-col gap-8 justify-center items-center  duration-500'>
                ...
                <Link href={''} className='group flex justify-center hover:animate-pulse items-center mt-6 gap-8 '>

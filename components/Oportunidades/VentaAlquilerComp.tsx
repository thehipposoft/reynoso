          ...
          <div className='flex py-20 flex-col md:w-[1300px] w-[90vw] mx-auto'>
              <div className='flex justify-between md:px-12 px-6'>
                ...
                <div className='content bg-slate-50 md:w-[496px] md:h-[600px] relative'>
                    ...
                    <div className='md:w-[105px] md:h-[115px] flex overflow-hidden flex-col justify-around items-center bg-primary-green absolute z-10 top-0 right-0 rounded-b-xl'>
                        <div className='h-[60px] relative flex justify-center items-center'>
                            <div className='flex relative z-20'>
                            <h4 className='text-primary-green text-4xl font-bold translate-x-1'>2</h4>
                            <h4 className='text-primary-green text-4xl pt-2 font-bold -translate-x-0.5'>4</h4>

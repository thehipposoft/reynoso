...
const ProyectoLayout = ({proyecto}:ProyectoLayoutProps) => {
  return (
    <div>
            ...
            }
            {
                ...
                <div className='flex justify-center items-center mt-4'>
                    <Link
                        ...
                        className={`flex gap-6 tracking-[3px] font-semibold uppercase rounded-3xl py-3 px-16 border hover:underline hover:scale-105 duration-300`}
                    >
                        ver brochure
        ...
        <div className='flex md:flex-row flex-col justify-between items-center md:w-[1300px] w-[90vw] py-8 mx-auto md:min-h-screen'>

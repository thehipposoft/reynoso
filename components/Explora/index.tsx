...
const Explora = () => {
  return (
    <div className='flex flex-col items-center md:w-[1300px] w-[90vw] mx-auto my-2'>
        ...
        <div className='bg-[#f5f5f5] md:w-[935px] w-[90vw] h-72 flex flex-col px-16 gap-12 justify-center'>
            <p className='font-semibold text-xl'>Explorá nuestros Desarrollos Inmobiliarios</p>

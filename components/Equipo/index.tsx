      ...
      <div className='flex relative flex-col max-w-[1300px] mx-auto mb-16'>
        <div className='flex md:flex-row flex-col-reverse items-start md:items-end justify-between'>
          <div className='flex flex-col mt-12 md:mt-0'>
            <h4 className='equipo font-poppins -tracking-wider font-bold text-title-color text-[38px] md:pb-14'>Nuestro Equipo de Profesionales</h4>
          </div>
          <div className='md:w-[700px] mx-auto md:mx-0 flex md:gap-2 gap-8 items-end overflow-hidden'>
            <div className='shape bg-primary-green md:w-40 pb-4 h-[320px] rounded-b-full flex items-end justify-center'>
            ...
            <div className='overflow-hidden py-1'>
              <h4 className='title__two md:text-5xl text-[26px] md:leading-10 -tracking-wide font-bold font-kadwa text-title-color pb-4'>Años <br className='hidden md:block'/> transformando el <br/> Mercado Inmobiliario</h4>
            </div>
          </div>
        </div>

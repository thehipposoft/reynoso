      ...
      <div className='flex relative flex-col max-w-[1300px] mx-auto mb-16'>
        <div className='flex md:flex-row flex-col-reverse items-start md:items-end justify-between px-12'>
          <div className='flex flex-col mt-12 md:mt-0'>
            <h2 className='title__one font-inter text-4xl'>Nuestro Equipo</h2>
            <h3 className='title__two text-primary-green text-4xl'>de profesionales</h3>
          </div>
          <div className='md:w-[665px] mx-auto md:mx-0 flex md:gap-2 gap-8 items-end'>
            ...
            <h4 className='md:text-4xl text-[26px] leading-7 md:leading-9 font-bold font-kadwa'>Años <br className='hidden md:block'/> transformando el <br/> Mercado Inmobiliario</h4>
          </div>
        </div>
          <EquipoGrid />
          <EquipoCarrousel />
